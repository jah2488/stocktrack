...
module User::GeneratedAttributeMethods
  ...
  sig { params(value: T.any(Date, Time, TZInfo::Timezone)).void }
  ...
  sig { params(value: T.any(Numeric, ActiveRecord::Relation)).void }
  def id=(value); end

  sig { returns(T::Boolean) }
  def id?; end

  sig { returns(T.nilable(TZInfo::Timezone)) }
  def remember_created_at; end

  sig { params(value: T.nilable(T.any(Date, Time, TZInfo::Timezone))).void }

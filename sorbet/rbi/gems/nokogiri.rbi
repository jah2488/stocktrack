...
class Nokogiri::XML::SAX::Parser::Attribute < Anonymous_Struct_46
end
...
class Nokogiri::XML::Notation < Anonymous_Struct_47
end
...
class Nokogiri::HTML::EntityDescription < Anonymous_Struct_48
end
